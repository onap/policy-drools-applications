...
public class Transaction implements Serializable {
    ...
    public ControlLoopNotification getNotification(ControlLoopEvent event) {
        ...
        ArrayList<ControlLoopOperation> histArrayList = new ArrayList<>(history);
        notification.setHistory(histArrayList);
    ...
    public ControlLoopNotification initialOperationNotification() {
        ...
        LinkedList<ControlLoopOperation> histLinkedList = new LinkedList<>();
        notification.setHistory(histLinkedList);
