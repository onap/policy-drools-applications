...
public class ControlLoopMetricsFeatureTest {
    ...
    public void validActiveNotification() throws InterruptedException {
        ...
        assertTrue(ControlLoopMetricsManager.getManager().getTransaction(requestId).getFrom().contains(testController.getName()));
    ...
    public void eviction() throws InterruptedException {
        ...
        assertEquals(ControlLoopMetricsManager.getManager().getCacheOccupancy(), ControlLoopMetricsManager.getManager().getCacheOccupancy());
        ...
        assertTrue(ControlLoopMetricsManager.getManager().getTransactionIds().size() == ControlLoopMetricsManager.getManager().getCacheSize());
        assertTrue(ControlLoopMetricsManager.getManager().getCacheOccupancy() == ControlLoopMetricsManager.getManager().getCacheSize());
        ...
        assertTrue(ControlLoopMetricsManager.getManager().getTransactionIds().size() == ControlLoopMetricsManager.getManager()
                .getCacheOccupancy());
        assertFalse(ControlLoopMetricsManager.getManager().getCacheOccupancy() == ControlLoopMetricsManager.getManager().getCacheSize());
