...
public class RulesTest {
    ...
    public static void setUpBeforeClass() {
        ...
        rules.start("src/main/resources");
    ...
    public void service123Compliant() {
        ...
        topics.waitForLockAndPermit(policy, policyClMgt);
        ...
        topics.waitForFinalSuccess(policy, policyClMgt);
    }
    ...
    public void duplicateEvents() {
        ...
        VirtualControlLoopNotification notif1 = topics.waitForFinalSuccess(policy, policyClMgt);
        VirtualControlLoopNotification notif2 = topics.waitForFinalSuccess(policy, policyClMgt);
