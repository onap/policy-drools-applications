...
/**
 * Based off of GuardContext.java. Much code is reused here verbatim. Some
 * functionality is not necessary but not removed to keep close similarity.
 * 
 */
