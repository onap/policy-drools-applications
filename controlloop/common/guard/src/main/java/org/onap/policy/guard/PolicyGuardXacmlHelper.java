...
public class PolicyGuardXacmlHelper {
	...
	public String callPDP(PolicyGuardXacmlRequestAttributes xacmlReq) {
		...
		try {
			...
			// Call RESTful PDP
			//
			netLogger.info("[OUT|{}->{}|]{}{}", PolicyGuardXacmlHelper.class, urlEntry.restURL, System.lineSeparator(), jsonReq.toString());
			...
			netLogger.info("[IN|{}->{}|]{}{}", urlEntry.restURL, PolicyGuardXacmlHelper.class, System.lineSeparator(), response);
		} catch (Exception e) {
