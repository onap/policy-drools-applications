...
public final class MSOManager {
	...
	private static Logger logger = LoggerFactory.getLogger(MSOManager.class);
	...
	public static MSOResponse createModuleInstance(String url, String urlBase, String username, String password, MSORequest request) {
		...
		if (httpDetails.a == 202) {
			try {
				...
				logger.error("{}: Failed to deserialize into MSOResponse: ",MSOManager.class, e);
			} catch (InterruptedException e) {
				logger.error("{}: Interrupted exception: ",MSOManager.class, e);
			}
		}
