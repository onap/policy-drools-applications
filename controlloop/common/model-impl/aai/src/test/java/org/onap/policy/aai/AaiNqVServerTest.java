...
public class AaiNqVServerTest {
    ...
    public void test() throws Exception {
        ...
        String json = new String(Files.readAllBytes(new File("src/test/resources/org/onap/policy/aai/AaiNqVServer.json").toPath()));
        ...
        assertEquals("http://localhost:8774/v2.1/4086f396c5e04caf9502c5fdeca575c4/servers/1c94da3f-16f1-4fc7-9ed1-e018dfa62774", resp.getVserverSelflink());
