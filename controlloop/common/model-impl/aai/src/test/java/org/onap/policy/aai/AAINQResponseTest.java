...
public class AAINQResponseTest {
	...
	public void Test() {
        ...
        genericVNFItem.extraProperties.extraProperty = new LinkedList<AAINQExtraProperty>();
        ...
        genericVNFItem.items.inventoryResponseItems = new LinkedList<AAINQInventoryResponseItem>();
        ...
        tenantItem.items.inventoryResponseItems = new LinkedList<AAINQInventoryResponseItem>();
        ...
        vserverItem.items.inventoryResponseItems = new LinkedList<AAINQInventoryResponseItem>();
