...
public class AaiCqInventoryResponseItemTest {
    ...
    public void testVserver() {
        ...
        try {
            fileString = new String(Files.readAllBytes(
                            new File("src/test/resources/org/onap/policy/aai/AaiCqVserver.json").toPath()));
        } catch (IOException e) {
        ...
        try {
            jaxbContext = JAXBContextFactory.createContext(new Class[] {Vserver.class, ObjectFactory.class},
                            properties);
    ...
    public void testGenericVnf() {
        ...
        try {
            fileString = new String(Files.readAllBytes(
                            new File("src/test/resources/org/onap/policy/aai/AaiCqGenericVnf.json").toPath()));
        } catch (IOException e) {
            LOGGER.info(e.getMessage(), e);
        }
        ...
        Unmarshaller unmarshaller;
        try {
            jaxbContext = JAXBContextFactory.createContext(new Class[] {GenericVnf.class, ObjectFactory.class},
                            properties);
            unmarshaller = jaxbContext.createUnmarshaller();
            // Create the StreamSource by creating StringReader using the JSON
            // input
    ...
    public void testVfModule() {
        ...
        try {
            fileString = new String(Files.readAllBytes(
                            new File("src/test/resources/org/onap/policy/aai/AaiCqVfModule.json").toPath()));
        } catch (IOException e) {
            LOGGER.info(e.getMessage(), e);
        }
        ...
        Unmarshaller unmarshaller;
        try {
            jaxbContext = JAXBContextFactory.createContext(new Class[] {VfModule.class, ObjectFactory.class},
                            properties);
            unmarshaller = jaxbContext.createUnmarshaller();
            // Create the StreamSource by creating StringReader using the JSON
            // input
    ...
    public void testTenant() {
        ...
        try {
            fileString = new String(Files.readAllBytes(
                            new File("src/test/resources/org/onap/policy/aai/AaiCqTenant.json").toPath()));
        } catch (IOException e) {
            LOGGER.info(e.getMessage(), e);
        }
    ...
    public void testCloudRegion() {
        ...
        try {
            fileString = new String(Files.readAllBytes(
                            new File("src/test/resources/org/onap/policy/aai/AaiCqCloudRegion.json").toPath()));
        } catch (IOException e) {
            LOGGER.info(e.getMessage(), e);
        }
        ...
        Unmarshaller unmarshaller;
        try {
            jaxbContext = JAXBContextFactory.createContext(new Class[] {CloudRegion.class, ObjectFactory.class},
                            properties);
            unmarshaller = jaxbContext.createUnmarshaller();
            // Create the StreamSource by creating StringReader using the JSON
            // input
