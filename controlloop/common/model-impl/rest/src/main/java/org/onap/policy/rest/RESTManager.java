...
public class RESTManager {
    ...
    private Pair<Integer, String> sendRequest(HttpRequestBase request) {
        if (logger.isDebugEnabled()) {
            logger.debug("***** sendRequest to url {}:", request.getURI().toString());
        }
        ...
        try (CloseableHttpClient client =
            ...
            if (response != null) {
                ...
                logger.error("Response from {} is null", request.getURI().toString());
                return null;
            }
        } catch (Exception e) {
            logger.error("Request failed to {}", request.getURI().toString(), e);
            return null;
        }
    }
