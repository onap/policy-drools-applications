...
public class AaiGetPnfStep2 extends Step2 {
    ...
    public boolean start(long remainingMs) {
        if (stepContext.contains(AaiGetTenantOperation.getKey(AaiGetPnfOperation.getKey(params.getTargetEntity())))) {
    ...
    public void success(OperationOutcome outcome) {
        ...
        stepContext.setProperty(AaiGetPnfOperation.getKey(params.getTargetEntity()), resp);
    }
}
