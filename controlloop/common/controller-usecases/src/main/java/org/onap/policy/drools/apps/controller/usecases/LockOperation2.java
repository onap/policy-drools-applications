...
public class LockOperation2 implements Operation {
    ...
    private final StepContext usecasesContext;
     ...
     *
     * @param usecasesContext the context to use to request the lock
     * @param event event being processed
     * @param params operation's parameters
     */
    public LockOperation2(StepContext usecasesContext, VirtualControlLoopEvent event,
    ...
    public CompletableFuture<OperationOutcome> start() {
        ...
        return usecasesContext.requestLock(targetEntity);
    }
