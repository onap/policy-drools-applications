...
public class GuardStep2Test {
    ...
    public void testGetPropertyNames() {
        ...
        assertThat(step.getPropertyNames()).isEqualTo(List.of(OperationProperties.AAI_TARGET_ENTITY));
        ...
        assertThat(step.getPropertyNames())
                        .isEqualTo(List.of(OperationProperties.AAI_TARGET_ENTITY, OperationProperties.DATA_VF_COUNT));
    }
