 ...
 * VFW Use Case Tests.
 */
public class Vfw2Test extends UsecasesBase2 {
     ...
     */
    private static final String APPC_SUCCESS = "src/test/resources/vfw/vfw.appc.success2.json";
    ...
    private void sunnyDay() throws IOException {
        ...
        /* Inject a 400 APPC Response Return over the APPC topic, with appropriate subRequestId */
    ...
    public void topicsRegistration() {
        ...
        appcClSink = createTopicSinkCallbackPlain(APPC_CL_TOPIC, Request.class);
