...
public class Step2Test {
    ...
    public void setUp() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of());
    ...
    public void testGetPropertyNames() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of("propA", "propB"));
    ...
    public void testSetProperties() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(
    ...
    public void testSetPropertiesUnknown() {
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of("unknown-property"));
    ...
    public void testLoadCloudRegion_testGetCloudRegion() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_DEFAULT_CLOUD_REGION));
    ...
    public void testLoadTenant_testGetTenant() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_DEFAULT_TENANT));
    ...
    public void testLoadPnf_testGetPnf() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_PNF));
    ...
    public void testLoadResourceVnf_testGetResourceVnf() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_RESOURCE_VNF));
    ...
    public void testLoadService_testGetService() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_SERVICE));
    ...
    public void testLoadServiceModel_testGetServiceModel() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_SERVICE_MODEL));
    ...
    public void testLoadVnf_testGetVnf() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_VNF));
    ...
    public void testLoadVnfModel_testGetVnfModel() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_VNF_MODEL));
    ...
    public void testLoadVserverLink_testGetVserverLink() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.AAI_VSERVER_LINK));
    ...
    public void testLoadVfCount_testGetVfCount() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.DATA_VF_COUNT));
    ...
    public void testLoadEnrichment_testGetEnrichment() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.ENRICHMENT_BANDWIDTH));
    ...
    public void testLoadAdditionalEventParams_testGetAdditionalEventParams() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.EVENT_ADDITIONAL_PARAMS));
    ...
    public void testLoadEventPayload_testGetEventPayload() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(OperationProperties.EVENT_PAYLOAD));
    ...
    public void testLoadOptCdsGrpcAaiProperties() {
        when(policyOperator.getPropertyNames(any()))
                        .thenReturn(List.of(OperationProperties.OPT_CDS_GRPC_AAI_PROPERTIES));
    ...
    public void testLoadDefaultGenericVnf_testGetDefaultGenericVnf() {
        ...
        when(policyOperator.getPropertyNames(any())).thenReturn(List.of(UsecasesConstants.AAI_DEFAULT_GENERIC_VNF));
