...
public class Step2Test {
    ...
    public void testGetPropertyNames() {
        ...
        // try when the list includes a PNF
        when(policyOperation.getPropertyNames()).thenReturn(List.of("propA", OperationProperties.AAI_PNF, "propB"));
        assertThat(step.getPropertyNames()).isEqualTo(
                        List.of("propA", OperationProperties.AAI_PNF, "propB", OperationProperties.AAI_TARGET_ENTITY));
    }
