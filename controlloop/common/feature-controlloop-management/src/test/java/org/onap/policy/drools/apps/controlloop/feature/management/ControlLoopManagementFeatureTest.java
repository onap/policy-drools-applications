...
public class ControlLoopManagementFeatureTest {
    ...
    public void getSequenceNumber() {
        Assert.assertEquals(new ControlLoopManagementFeature().getSequenceNumber(), 1000);
    }
    ...
    @Test
    public void getName() {
        Assert.assertEquals(new ControlLoopManagementFeature().getName(),  "controlloop-management");
    }
}