...
public class MSOActorServiceProvider implements Actor {
	...
	public MSOActorServiceProvider() {
		...
		vnfItemVnfId = null; // this is the vnfInstanceId
		this.vnfItemVnfType = null;
		this.vnfItemModelInvariantId = null;
		this.vnfItemModelVersionId = null;
		this.vnfItemModelName = null; 
		this.vnfItemModelVersion = null;
	    this.vnfItemModelNameVersionId = null;
	    serviceItemServiceInstanceId = null; // this is the serviceInstanceId
	    this.serviceItemPersonaModelId = null;
	    this.serviceItemModelName = null;
	    this.serviceItemModelType = null;
	    this.serviceItemModelVersion = null;
	    this.serviceItemModelNameVersionId = null;
	    this.vfModuleItemVfModuleName = null;
	    this.vfModuleItemPersonaModelId = null;
	    this.vfModuleItemPersonaModelVersion = null;
	    this.vfModuleItemModelName = null;
	    this.vfModuleItemModelNameVersionId = null;
	    this.tenantItemTenantId = null;
	    this.cloudRegionItemCloudRegionId = null;
	}
...
//		insert(aainqf199RequestWrapper);
		...
		if (aainqf199response == null) {
			logger.error("Failed to get AAI response");
...
//			insert(aainqf199ResponseWrapper);
	...
	private void extractSOFieldsFromNamedQuery(AAINQF199ResponseWrapper namedQueryResponseWrapper, VirtualControlLoopEvent onset) {
		...
		if (checkExtractedFields() == false) {
			logger.error("some fields are missing from AAI response.");
			return;
		}
	}
	...
	public SORequest constructRequest(VirtualControlLoopEvent onset, ControlLoopOperation operation, Policy policy) {
		...
		if (checkExtractedFields() == false) {
			...
			logger.error("AAI response is missing some required fields. Cannot proceed with SO Request construction.");
			return null;
