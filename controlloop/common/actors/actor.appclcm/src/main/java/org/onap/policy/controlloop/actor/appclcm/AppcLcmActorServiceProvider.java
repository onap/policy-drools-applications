...
public class AppcLcmActorServiceProvider implements Actor {
    ...
    public static LCMRequestWrapper constructRequest(VirtualControlLoopEvent onset, ControlLoopOperation operation,
         ...
         * a vnf-id.
         */
        HashMap<String, String> requestActionIdentifiers = new HashMap<String, String>();
         ...
         * identifiers.
         */
        if (policy.getRecipe().equalsIgnoreCase("Restart") || policy.getRecipe().equalsIgnoreCase("Rebuild")
                || policy.getRecipe().equalsIgnoreCase("Migrate")) {
    ...
    public static SimpleEntry<PolicyResult, String> processResponse(LCMResponseWrapper dmaapResponse) {
        ...
        if (appcResponse.getStatus() == null) {
            ...
            return new AbstractMap.SimpleEntry<PolicyResult, String>(PolicyResult.FAILURE_EXCEPTION, message);
        }
        ...
        return new AbstractMap.SimpleEntry<PolicyResult, String>(result, message);
    }
