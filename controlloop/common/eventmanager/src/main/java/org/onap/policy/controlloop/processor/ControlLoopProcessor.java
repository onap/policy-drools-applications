...
public class ControlLoopProcessor implements Serializable {
    ...
    public ControlLoopProcessor(ToscaPolicy toscaPolicy) throws ControlLoopException {
        try {
            ...
            controlLoop.setAbatement(policy.getProperties().isAbatement());
            controlLoop.setControlLoopName(policy.getProperties().getId());
            controlLoop.setTimeout(policy.getProperties().getTimeout());
            controlLoop.setTrigger_policy(policy.getProperties().getTrigger());
            controlLoop.setVersion(policy.getVersion());
