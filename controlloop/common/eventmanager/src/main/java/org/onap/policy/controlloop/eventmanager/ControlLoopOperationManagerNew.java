...
import org.onap.policy.controlloop.actor.so.SoActorServiceProviderNew;
import org.onap.policy.controlloop.actor.vfc.VfcActorServiceProviderNew;
...
public class ControlLoopOperationManagerNew implements Serializable {
     ...
     */
    public ControlLoopOperationManagerNew(ControlLoopEvent onset, Policy policy, ControlLoopEventManager em)
        ...
        switch (policy.getTarget().getType()) {
            ...
            case VNF:
                ...
                if (this.onset.getTarget().equalsIgnoreCase(VSERVER_VSERVER_NAME)) {
                     ...
                     */
                    String vnfId = this.eventManager.getCqResponse((VirtualControlLoopEvent) onset)
                            .getDefaultGenericVnf().getVnfId();
                    if (vnfId == null) {
    ...
    public Object startOperation(/* VirtualControlLoopEvent */ControlLoopEvent onset)
        ...
        switch (policy.getActor()) {
            case "APPC":
                ...
                return operationRequest;
            case "SO":
                SoActorServiceProviderNew soActorSp = new SoActorServiceProviderNew();
                ...
                return operationRequest;
            case "VFC":
                this.operationRequest = VfcActorServiceProviderNew.constructRequest((VirtualControlLoopEvent) onset,
