...
public class ControlLoopOperationManager implements Serializable {
    ...
    private Map<String, String> buildAaiParams() throws AaiException {
        ...
        if (TargetType.VNF.equals(policy.getTarget().getType())
            ...
            AaiCqResponse cqResponse = this.eventManager.getCqResponse((VirtualControlLoopEvent) onset);

            ServiceInstance serviceInstance = cqResponse.getServiceInstance();
            ...
            GenericVnf genericVnf = cqResponse.getGenericVnfByModelInvariantId(policy.getTarget().getResourceID());
            if (genericVnf == null) {
