...
public class ControlLoopEventManager2 implements ManagerContext, Serializable {
        ...
        static {
            ...
            try {
                ...
                if (!guard.isConfigured()) {
                    logger.warn("cannot check 'disabled' property in GUARD actor - assuming enabled");
    ...
    private ControlLoopOperationManager2 makeOperationManager() throws ControlLoopException {
        return new ControlLoopOperationManager2(this, context, processor.getCurrentPolicy(), ForkJoinPool.commonPool());
    }
