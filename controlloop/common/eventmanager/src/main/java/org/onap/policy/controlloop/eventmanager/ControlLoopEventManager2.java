...
public class ControlLoopEventManager2 implements ManagerContext, Serializable {
    ...
    protected ControlLoopOperationManager2 makeOperationManager() throws ControlLoopException {
        return new ControlLoopOperationManager2(this, context, processor.getCurrentPolicy(), getExecutor());
    }
