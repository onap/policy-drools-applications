...
public class Step {
     ...
     *
     * @param targetEntity new target entity
     */
    public void init(String targetEntity) {
        if (operation != null) {
            throw new IllegalStateException("already initialized");
        }

        if (params.getTargetEntity() == null) {
            params = params.toBuilder().targetEntity(targetEntity).build();
        }
