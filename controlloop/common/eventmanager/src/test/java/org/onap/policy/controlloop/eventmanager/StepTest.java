...
public class StepTest {
    ...
    @Test
    public void testConstructorWithOtherStep_testInitStartTime() {
    ...
    @Test
    public void testIsInitialized_testGetOperation() {
    ...
    public void testHandleTimeout() throws InterruptedException {
        ...
        assertNotEquals(PolicyResult.SUCCESS, outcome.getResult());
        assertEquals(Step.CL_TIMEOUT_ACTOR, outcome.getActor());
        assertTrue(outcome.isFinalOutcome());
