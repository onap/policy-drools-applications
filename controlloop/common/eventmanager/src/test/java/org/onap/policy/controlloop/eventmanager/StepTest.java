...
public class StepTest {
    ...
    public void testIsInitialized_testInit_testGetOperation() {
        ...
        assertThatIllegalStateException().isThrownBy(() -> step.init(MY_TARGET)).withMessage("already initialized");
        ...
        // start with null target
        params = params.toBuilder().targetEntity(null).build();
        step = new Step(params, startTime);
        step.init("targetD");
        assertEquals("targetD", step.getParams().getTargetEntity());
    }
