...
public class ControlLoopXacmlGuardTest {
	...
	public void runTest(String droolsTemplate, 
		...
		//
		PolicyGuardYamlToXacml.fromYamlToXacml("src/test/resources/yaml/policy_guard_vUSP_1707_appc_restart.yaml", 
						"src/main/resources/frequency_limiter_template.xml", 
						"src/test/resources/xacml/autogenerated_frequency_limiter_restart.xml");
		
		PolicyGuardYamlToXacml.fromYamlToXacml("src/test/resources/yaml/policy_guard_vUSP_1707_appc_rebuild.yaml", 
						"src/main/resources/frequency_limiter_template.xml", 
						"src/test/resources/xacml/autogenerated_frequency_limiter_rebuild.xml");
		
		PolicyGuardYamlToXacml.fromYamlToXacml("src/test/resources/yaml/policy_guard_vUSP_1707_appc_rebuild_1.yaml", 
						"src/main/resources/frequency_limiter_template.xml", 
						"src/test/resources/xacml/autogenerated_frequency_limiter_rebuild_1.xml");
		
		PolicyGuardYamlToXacml.fromYamlToXacml("src/test/resources/yaml/policy_guard_vUSP_1707_appc_migrate.yaml", 
						"src/main/resources/frequency_limiter_template.xml", 
