...
public class GuardAdjunct implements Transaction.Adjunct, Serializable {
    ...
    // this provides the ability to override methods for Junit tests
    private static StaticMethods staticMethods = new StaticMethods();
    ...
    public static void create(Transaction transaction, GuardContext context) {
        staticMethods.create(transaction, context);
    }
    ...
    /**
     * This class contains the implementation of static methods in
     * 'GuardAdjunct'. The behavior can be overridden in Junit tests by using
     * 'Whitebox' to modify the field 'GuardAdjunct.staticMethods'.
     */
    public static class StaticMethods {
         ...
         * @param context the GuardContext derived from the controller properties
         */
        public void create(Transaction transaction, GuardContext context) {
