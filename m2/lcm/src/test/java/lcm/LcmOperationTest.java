...
public class LcmOperationTest {

    public static Policy policy;
    public static VirtualControlLoopEvent event;
    public static Transaction transaction;
    public static LcmOperation operation;
    ...
    public static void cleanup() {
        transaction.getAdjunct(LockAdjunct.class).cleanup(transaction);
        PolicyEngineConstants.getManager().stop();
    }

    @Test
    public void getVmRestartRequestTest() {

        policy.setRecipe("RESTART");
        policy.getTarget().setType(TargetType.VM);
        operation = new LcmOperation(transaction, policy, event, 1);
        ...
        System.out.println("vm restart request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVnfRestartRequestTest() {
        ...
        System.out.println("vnf restart request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVmRebuildRequestTest() {
        ...
        System.out.println("vm rebuild request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVnfRebuildRequestTest() {
        ...
        System.out.println("vnf rebuild request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVmMigrateRequestTest() {
        ...
        System.out.println("vm migrate request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVnfMigrateRequestTest() {
        ...
        System.out.println("vnf migrate request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVmEvacuateRequestTest() {
        ...
        System.out.println("vm evacuate request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVnfEvacuateRequestTest() {
        ...
        System.out.println("vnf evacuate request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVmRebootRequestTest() {
        ...
        System.out.println("vm reboot request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVnfRebootRequestTest() {
        ...
        System.out.println("vnf reboot request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVnfStartRequestTest() {
        ...
        System.out.println("vnf start request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVmStartRequestTest() {
        ...
        System.out.println("vm start request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVnfStopRequestTest() {
        ...
        System.out.println("vnf stop request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));

    }

    @Test
    public void getVmStopRequestTest() {
        ...
        System.out.println("vm stop request: " + Serialization.gson.toJson(request, AppcLcmDmaapWrapper.class));
    ...
    public void validAaiSubtagTest() {
        ...
        validEvent.getAai().put(LcmOperation.DCAE_CLOSEDLOOP_DISABLED_FIELD, "false");
        validEvent.getAai().put(validEvent.getTarget(), "VM001");
        assertTrue(LcmOperation.isAaiValid(transaction, validEvent));
    ...
    public void noAaiSubtagTest() {
        ...
        assertFalse(LcmOperation.isAaiValid(transaction, noAaiTag));
    ...
    public void noClosedLoopDisabledInAaiTest() {
        ...
        assertFalse(LcmOperation.isAaiValid(transaction, invalidEvent));
        assertEquals(LcmOperation.DCAE_CLOSEDLOOP_DISABLED_FIELD
    ...
    public void closedLoopDisabledInAaiTest() {
        transaction.setNotificationMessage(null);
        VirtualControlLoopEvent invalidEvent = new VirtualControlLoopEvent();
        invalidEvent.getAai().put(LcmOperation.DCAE_CLOSEDLOOP_DISABLED_FIELD, "true");
        assertFalse(LcmOperation.isAaiValid(transaction, invalidEvent));
        assertEquals(LcmOperation.DCAE_CLOSEDLOOP_DISABLED_FIELD
    ...
    public void targetMismatchInAaiTest() {
        ...
        validEvent.setTarget("vserver.vserver-name");
        validEvent.getAai().put(LcmOperation.DCAE_CLOSEDLOOP_DISABLED_FIELD, "false");
        assertFalse(LcmOperation.isAaiValid(transaction, validEvent));
