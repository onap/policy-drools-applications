...
public class LcmHealthCheckOperation extends LcmOperation {
    public static final String DCAE_IPV4_ADDR =
        "vserver.l-interface.l3-interface-ipv4-address-list.l3-inteface-ipv4-address";

    private static Logger logger = LoggerFactory.getLogger(LcmHealthCheckOperation.class);

    private static final long serialVersionUID = 4969322301462776173L;

    public LcmHealthCheckOperation(Transaction transaction, Policy policy,
    ...
    private String getVnfHealthState(String jsonPayload) {
        HashMap<String, Object> healthCheckPayloadMap = new Gson().fromJson(
            jsonPayload, new TypeToken<HashMap<String, Object>>() {
            }.getType());
    ...
    public void incomingMessage(Object object) {
        ...
        //
        LcmResponseCode responseValue = LcmResponseCode
        ...
        switch (responseValue) {
            ...
            case SUCCESS:
                ...
                //
                if (response.getPayload() == null || response.getPayload().equals("")) {
                    //
