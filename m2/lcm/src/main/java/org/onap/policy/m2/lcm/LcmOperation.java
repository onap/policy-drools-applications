...
package org.onap.policy.m2.lcm;
 ...
 */
public class LcmOperation implements Operation, LockAdjunct.Requestor, Serializable {
    ...
    private static Logger logger = LoggerFactory.getLogger(LcmOperation.class);
     ...
     */
    public LcmOperation(Transaction transaction, Policy policy, ControlLoopEvent onset,
        int attempt) {
    ...
    private static boolean isClosedLoopDisabled(Map<String, String> map) {
        ...
        return (disabled.equalsIgnoreCase("true") || disabled.equalsIgnoreCase("y"));
    }
    ...
    public void incomingMessage(Object object) {
        ...
        //
        LcmResponseCode responseValue = LcmResponseCode.toResponseValue(response.getStatus().getCode());
    ...
    void completeOperation(
        Integer attempt, String message, PolicyResult result) {
