 ...
 */
public class LcmActor implements Actor, Serializable {
    /* *******************/
    /* 'Actor' interface */
    /* *******************/
    ...
    public Operation createOperation(
        ...
        if ("healthcheck".equals(policy.getRecipe().toLowerCase())) {
            return new LcmHealthCheckOperation(transaction, policy, onset, attempt);
        }
        return new LcmOperation(transaction, policy, onset, attempt);
    }
}
