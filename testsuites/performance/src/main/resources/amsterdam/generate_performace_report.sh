...
# Pre-requisites:
#
# Run the JMeter Performance test plan (see below link) on the PDP-D for
# atleast few hours so that enough samples are collected and used for
...
#	./generate_performance_report -l /var/log/onap/policy/pdpd
