...
# 2: Unzip the relevant network log files
# 3: Pass following parameters to run the script
#    - log-dir : the complete directory location of network.log file.
#
...
# used to compute the average difference between "out" requests and "in"
# responses
diff_total = 0
diff_count = 0
...
#
# scans a file, computing time differences between "out" and "in", and
# updates diff_total and diff_count
#
